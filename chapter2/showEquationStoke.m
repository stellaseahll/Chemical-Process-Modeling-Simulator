function showEquationStoke(size,denF,denP,vis,Res)
set(gca,'xtick',[]);
set(gca,'ytick',[]);
axis([-1,20,-30,3]);

showValues(size,denF,denP,vis);
equationStokes(size,denF,denP,vis,Res);
...
function equationStokes(size,denF,denP,vis,Res)
