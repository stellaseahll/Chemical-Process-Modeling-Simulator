function varargout = chapter3_stoke(varargin)
% CHAPTER3_STOKE MATLAB code for chapter3_stoke.fig
%      CHAPTER3_STOKE, by itself, creates a new CHAPTER3_STOKE or raises the existing
%      singleton*.
%
%      H = CHAPTER3_STOKE returns the handle to a new CHAPTER3_STOKE or the handle to
%      the existing singleton*.
%
%      CHAPTER3_STOKE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CHAPTER3_STOKE.M with the given input arguments.
%
%      CHAPTER3_STOKE('Property','Value',...) creates a new CHAPTER3_STOKE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before chapter3_stoke_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to chapter3_stoke_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help chapter3_stoke

% Last Modified by GUIDE v2.5 27-Dec-2013 15:51:59

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @chapter3_stoke_OpeningFcn, ...
                   'gui_OutputFcn',  @chapter3_stoke_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before chapter3_stoke is made visible.
function chapter3_stoke_OpeningFcn(hObject, eventdata, handles, varargin)
%include functions
...
% UIWAIT makes chapter3_stoke wait for user response (see UIRESUME)
% uiwait(handles.calculate);


% --- Outputs from this function are returned to the command line.
function varargout = chapter3_stoke_OutputFcn(hObject, eventdata, handles) 
