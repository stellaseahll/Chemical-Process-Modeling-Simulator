function showSedimentation2(n,Ut,C,Uint,Ups)
...
str2=strcat('$$Since\hspace{2mm}CB=',sprintf('%.4f',C(2)),'\hspace{2mm}is\hspace{2mm}not\hspace{2mm}between\hspace{2mm}',...
...
text('FontSize',15,'Position',[0 -12*1.2],'Interpreter','latex','String',strUpsA);
%B
...
text('FontSize',15,'Position',[0 -13*1.2],'Interpreter','latex','String',strUpsB1);
text('FontSize',15,'Position',[0 -14*1.2],'Interpreter','latex','String',strUpsB2);
%S
strUpsS='$$Settling\hspace{2mm}flux\hspace{2mm}of\hspace{2mm}sediment\hspace{2mm}\hspace{2mm}S,\hspace{2mm}U_{ps,S}=\bf{0}$$';
text('FontSize',15,'Position',[0 -15*1.2],'Interpreter','latex','String',strUpsS);
%Bmin
...
text('FontSize',15,'Position',[0 -16*1.2],'Interpreter','latex','String',strUpsBmin1);
text('FontSize',15,'Position',[0 -17*1.2],'Interpreter','latex','String',strUpsBmin2);
%Bmax
strUpsBmax1='$$Settling\hspace{2mm}flux\hspace{2mm}of\hspace{2mm}suspension\hspace{2mm}B_{max}\hspace{1mm},\hspace{2mm}U_{ps,B_{max}}$$';
strUpsBmax2=sprintf('$$=U_TC_{B_{max}\\hspace{2mm}}(1-C_{B_{max}\\hspace{2mm}})^n=%.5f(%.4f)(1-%.4f)^{%.3f}\\hspace{2mm}=\\bf{%.5f\\hspace{1mm}m/s}$$',Ut,C(4),C(4),n,Ups(4));
text('FontSize',15,'Position',[0 -18*1.2],'Interpreter','latex','String',strUpsBmax1);
text('FontSize',15,'Position',[0 -19*1.2],'Interpreter','latex','String',strUpsBmax2);
...
text('FontSize',15,'Position',[0 -22*1.2],'Interpreter','latex','String',strUab);
...
text('FontSize',15,'Position',[0 -24*1.2],'Interpreter','latex','String',strUbs);